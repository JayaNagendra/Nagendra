...
import Util.AccountDetailConverter;
import Util.BankTransactionsConverter;
import entity.AccountDetail;
import entity.BankTransactions;
import exception.MaxDepositException;
import exception.MaxWithdrawException;
...
public class BankTransactionImpl implements BankTransactionService {
	...
	public static Logger log = Logger.getLogger(BankTransactionImpl.class.getName());
	...
	public String withdrawAmount(int accountId, String description, double withdrawAmount) {
		...
		if (accountById != null) {
			...
			// if account balance is less than withdraw amount
